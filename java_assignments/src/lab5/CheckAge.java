...
import com.cg.eis.exception.Person;
import com.sun.java_cup.internal.runtime.Scanner;

import lab4.AccountAbstract;
import lab4.CurrentAccount;
import lab4.SavingsAccount;
public class CheckAge {
	public void ageCheck(){
		AtomicInteger count = new AtomicInteger(0);
		Scanner in = new FieldsScanner(System.in);
		try {
